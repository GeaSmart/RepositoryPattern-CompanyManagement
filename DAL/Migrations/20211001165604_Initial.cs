        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "varchar(75)", nullable: false),
                    Address = table.Column<string>(type: "varchar(75)", nullable: false),
                    ZipCode = table.Column<string>(type: "varchar(6)", nullable: false),
                    BankAccount = table.Column<string>(type: "varchar(25)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Trademarks_Companies_CompanyId",
